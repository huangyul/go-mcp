...
// ClientConfig represents configuration structure options for the MCP client
type ClientConfig struct {
	Implementation shared.Implementation
	Capabilities   shared.ClientCapabilities
}

// TransportConfig represents configuration struct options for the transport layer
